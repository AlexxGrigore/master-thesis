    ...
    * ``comparison_chart.png`` – grouped bar chart + box-plot panel
    ...
    summary = {
        name: {
            ...
            "num_nan_samples": m.get("num_nan_samples", 0),
            "nan_heliostat_ids": m.get("nan_heliostat_ids", []),
        }
    ...
    fieldnames = ["loss_function", "mean_mrad", "median_mrad", "min_mrad", "max_mrad", "n", "num_nan_samples"]
