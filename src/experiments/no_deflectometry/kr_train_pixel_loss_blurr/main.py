...
OUTPUT_DIR = (
    BASE_DIR / "outputs" / "local_runs" / "no_deflectometry" / f"pixel_loss_kr_blurr_{_run_timestamp}"
    if not IS_ON_DAIC
    else BASE_DIR / "outputs" / "no_deflectometry" / f"pixel_loss_kr_blurr_{_run_timestamp}"
)
