...
# Balanced dataset generated by one_heliostat_demo/generate_all.py (pooled, filtered).
# Old path kept below for reference but is no longer used.
...
# Scenario template — one .h5 per heliostat (same as one_heliostat_demo).
SCENARIO_PATH_TEMPLATE = str(ONE_HELIOSTAT_SCENARIOS_DIR / "{heliostat_id}" / "scenario.h5")

# ---------------------------------------------------------------------------
# Data splits (legacy — kept for reference, not used by the new pipeline)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# one_heliostat_demo pipeline params  (read by one_heliostat_demo/single_heliostat/train.run())
# ---------------------------------------------------------------------------

# DatasetSplitter config
...
# Ray counts and surface resolution
...
# Perturbation bounds for parameter clamping
