#!/bin/bash
#SBATCH --job-name=f63_synth_pixel
#SBATCH --output=/home/nfs/agrigore/projects/githubProjects/master-thesis/logs/f63_synth_pixel_out_%j.log
#SBATCH --error=/home/nfs/agrigore/projects/githubProjects/master-thesis/logs/f63_synth_pixel_err_%j.log
#SBATCH --time=2:00:00
