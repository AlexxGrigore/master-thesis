#!/bin/bash
#SBATCH --job-name=train_sizes_azimuth
#SBATCH --output=/home/nfs/agrigore/projects/githubProjects/master-thesis/logs/train_sizes_azimuth_out_%j.log
#SBATCH --error=/home/nfs/agrigore/projects/githubProjects/master-thesis/logs/train_sizes_azimuth_err_%j.log
