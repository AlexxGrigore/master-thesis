...
scenario_path = pathlib.Path("../scenarios/one_heliostat_scenarios/scenario1.h5")

# Specify the path to your tower-measurements.json file.
tower_file = pathlib.Path(
    "../paint_dataset/WRI1030197-tower-measurements.json"
)
...
heliostat_files_list = [
    (
        "AA31",
        pathlib.Path(
            "../paint_dataset/AA31/Properties/AA31-heliostat-properties.json"
        ),
        pathlib.Path("../paint_dataset/AA31/Deflectometry/AA31-filled-2023-09-18Z11-50-48Z-deflectometry.h5"),
    ),
    # (
    #     "name2",
    #     pathlib.Path(
